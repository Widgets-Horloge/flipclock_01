...
$(window).addEvent("domready", function () {
  ...
  var setClock = function () {
    ...
    if (currentHour != hour) {
      currentHour = hour;
      var hourText = hour < 10 ? "0" + hour : hour; // Toujours afficher deux chiffres
      // Suppression de la logique AM/PM

      var $newHourTop = new Element("div", {
        class: "digit-top",
        html: $hourTop.get("html"),
        style: "z-index:1;",
      });
    ...
    if (currentMin != min) {
      ...
      var $newMinTop = new Element("div", {
        class: "digit-top",
        html: $minTop.get("html"),
        style: "z-index:1;",
      });
